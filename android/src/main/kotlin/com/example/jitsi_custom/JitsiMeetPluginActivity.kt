package com.example.jitsi_custom
...
import com.example.jitsi_custom.JitsiMeetPlugin.Companion.JITSI_MEETING_CLOSE
import com.example.jitsi_custom.JitsiMeetPlugin.Companion.JITSI_PLUGIN_TAG
...
class JitsiMeetPluginActivity : JitsiMeetActivity() {
    ...
    override fun onPictureInPictureModeChanged(isInPictureInPictureMode: Boolean) {
        ...
        if (!isInPictureInPictureMode && onStopCalled) jitsiView.leave()
    }
