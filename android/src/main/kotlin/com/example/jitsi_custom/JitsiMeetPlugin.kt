...
public class JitsiMeetPlugin() : FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  private fun joinMeeting(call: MethodCall, result: Result) {
    ...
    optionsBuilder
      ...
      .setFeatureFlag("resolution", false)
      ...
      .setFeatureFlag("toolbarButtons.hangup",false)
      .setConfigOverride("hangup", false)
      .setConfigOverride("TOOLBAR_BUTTONS", arrayOf("camera", "microphone"))
